    ...
    <div class="sidebar">
        ...
        <div class="form-inline">
            <div class="input-group" data-widget="sidebar-search">
                <input class="form-control form-control-sidebar" type="search" placeholder="Search" aria-label="Search" id="text-search-form">
                <div class="input-group-append">
                    <button class="btn btn-sidebar" onclick="searchClick()">
